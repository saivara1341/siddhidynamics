    ...
    <section ref={ref} className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            We are proud to be incubated at the Hive Incubation Cell, fostering innovation and entrepreneurship
          </motion.p>
        </motion.div>
            ...
            >
              ...
              <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
                ...
                <div className="text-center md:text-left">
                  ...
                  >
                    Empowering startups with resources, mentorship, and a collaborative ecosystem to transform innovative ideas into successful ventures.
                  </motion.p>
                </div>
              </div>
            </motion.div>
